...
public class StringBasic {
    ...
    public String basicFunctions(String s) {
         ...
         * start is included
         * end is excluded
         * So it takes characters from index start up to end - 1.
         * 
         * Example with s = "abcde" (indexes: 0 1 2 3 4):
         * 
         * s.substring(0, 1) → "a"
         * s.substring(0, 3) → "abc"
         * s.substring(2, 5) → "cde"
         * s.substring(2, 2) → "" (empty string)
         */
    ...
    public static void main(String[] main) {
        ...
        // System.out.println(((Object)s.length()).getClass()); // to get the what type
        // of shit this is
